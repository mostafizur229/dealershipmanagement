...
namespace IMSWEB
{
    public class ViewModelToDomainMappingProfile : Profile
    {
        public ViewModelToDomainMappingProfile()
        {
            ...
            .ForMember(m => m.CompanyID, map => map.MapFrom(vm => vm.CompanyId))
            ...
            .ForMember(vm => vm.LimitedStkQty, map => map.MapFrom(m => m.LimitedStkQty));
            #endregion
            ...
            .ForMember(m => m.IsSupplier, map => map.MapFrom(vm => vm.IsSupplier))
            .ForMember(m => m.ConcernID, map => map.MapFrom(vm => int.Parse(vm.ConcernId)));
            #endregion
            ...
            .ForMember(m => m.ContactNo, map => map.MapFrom(vm => vm.ContactNo))
            .ForMember(m => m.Address, map => map.MapFrom(vm => vm.Address))
            .ForMember(m => m.IsBoth, map => map.MapFrom(vm => vm.IsBoth))
            ...
            .ForMember(m => m.LabourCost, map => map.MapFrom(vm => vm.LabourCost))
            ;
            #endregion
            ...
            .ForMember(m => m.SDetailID, map => map.MapFrom(vm => int.Parse(vm.StockDetailId.Trim(','))))
            ...
            .ForMember(m => m.DOrderDetailID, map => map.MapFrom(vm => vm.DOrderDetailID))
            ;
            ...
            #region PaymentOptionVM, PaymentOption
            CreateMap<PaymentOptionVM, PaymentOption>();
            #endregion
            ...
            CreateMap<CreateColorViewModel, Vehicle>()
            .ForMember(m => m.VehicleID, map => map.MapFrom(vm => int.Parse(vm.Id)))
            .ForMember(m => m.Code, map => map.MapFrom(vm => vm.Code))
            .ForMember(m => m.Name, map => map.MapFrom(vm => vm.Name))          
            ;
            #endregion
            ...
            #region CreateZoneViewModel, Zone
            CreateMap<CreateZoneViewModel, Zone>()
            .ForMember(m => m.ZoneID, map => map.MapFrom(vm => int.Parse(vm.Id)))
            .ForMember(m => m.Code, map => map.MapFrom(vm => vm.Code))
            .ForMember(m => m.ZoneName, map => map.MapFrom(vm => vm.Name))
            .ForMember(m => m.ConcernID, map => map.MapFrom(vm => int.Parse(vm.ConcernId)));
            #endregion
