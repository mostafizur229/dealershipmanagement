...
{
    [Authorize]
    public class AllowancesRuleSetupController : CoreController
    {
        IMapper _mapper;
        ...
        public AllowancesRuleSetupController(IErrorService errorService, IAllowanceDeductionService allowanceDeductionService,
        ...
        {
            var adparambasics = _ADParameterBasicService.GetAllowancesDeductionRuleSetupAsPerGrade((int)EnumAllowOrDeduct.Allowance);
        ...
        private ActionResult ReturnCreateViewWithTempData()
        {
            ...
            ViewBag.Allowances = new SelectList(allowances, "AllowDeductID", "Name");
        ...
        private void CheckSaveError(CreateAllowancesRuleSetupViewModel NewCreateAllowancesRuleSetupViewModel, FormCollection formCollection)
        {
            ...
            if (Grades.Count() == 0)
            {
                ...
                AddToastMessage("", "Please select Grades.", ToastType.Error);
            }
        ...
        private void Save(CreateAllowancesRuleSetupViewModel NewCreateAllowancesRuleSetupViewModel, FormCollection formcollection)
        {
            ...
            NewCreateAllowancesRuleSetupViewModel.ADParameterBasicCreate.AllowOrDeduct = (int)EnumAllowOrDeduct.Allowance; ;
        ...
        {
            _ADParamADParameterGradeService.Delete(id);
            _ADParamADParameterGradeService.Save();
            _ADParameterBasicService.Delete(id);
            _ADParameterBasicService.Save();
